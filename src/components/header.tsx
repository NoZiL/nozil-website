...
import { navigationLinks, navigationLinksWithoutHome } from "@/navigation";
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        {navigationLinksWithoutHome.map(({ href, title }) => (
  ...
  return (
    ...
    >
      <Image
        ...
        className={clsx(
          "rounded-full bg-zinc-100 object-cover dark:bg-zinc-800 hover:opacity-50",
...
export function Header() {
  ...
  return (
    <>
      <header
        className="pointer-events-none select-none relative z-50 flex flex-none flex-col"
        style={{
